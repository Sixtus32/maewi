<main class="main">
    ...
    <section class="top_section full_screen_section section">
        <div class="left">
            <h2>Diviértete Como Nunca <br> Haciendo Amigos</h2>
            <p class="section_hero_description">Una plataforma para <br> organizar planes y eventos</p>
            <div class="hero_btns">
                <button class="primary_btn btn view_modal-login" id="view-modal-login">Crear una cuenta</button>
                <button class="secondary_btn btn view_modal-sign" id="view-modal-sign-up">Iniciar Sesión</button>
            </div>
        </div>
    ...
    <section class="full_screen_section first_main_section section">
        ...
        <p class="section_description">Postea, elabora planes <br> y eventos emocionantes en Maewi.</p>
    ...
    <section class="full_screen_section section">
        ...
        <p class="section_description">Sal de tu zona de confort, <br> y traza nuevos planes al instante.</p>
    ...
    <section class="full_screen_section section">
        ...
        <p class="section_description">
            Compra y vende pases o entradas <br> en Maewi para participar en planes <br> y eventos en tu zona.
        </p>
